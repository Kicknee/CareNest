        ...
        >
          ...
          {menu.items.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="hover:bg-hover my-2 flex items-center justify-center gap-2 px-3 py-1 text-white hover:rounded-4xl hover:shadow-2xl lg:justify-start [&>.menu-icon]:size-[30px]"
            >
              {item.icon}
